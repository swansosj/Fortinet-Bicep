...
param subnet5Name = 'RouteServerSubnet'
param subnet5Prefix = '10.0.4.0/27'
param subnet5StartAddress = '10.0.4.4'
...
param publicIP4NewOrExisting = 'new'
param publicIP4ResourceGroup = ''
param publicIP4Name = ''
...
param adminUsername = 'sheldonswanson'
param adminPassword = 'MyPassword1234!'
